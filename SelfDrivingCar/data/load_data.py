...
class GTAVDataFeeder(object):
    def __init__ (self, episodeSize=80, max_iter=0, isLast=False, jsonFolder='FData', imgFolder='Frames', filePrefix='frame'):
        self.episodeSize = episodeSize # Number of RNN Unrolling
        self.max_iter = max_iter
        self.num_iter = 0
        self.isLast = isLast # Have we seen the last frame of this drive
        self.driveFolder = raw_input("Enter Data Folder: ")
